...
local simulationStrongholdMenu = {
...
local simulationMenu = {
	{"&Banished"                  , env .. "playonlinux --run 'Banished32x'"                       , nil                                            },
	{"&Stronghold games"          , simulationStrongholdMenu                                       , nil                                            },
...
local toolsOtherMenu = {
	{"&Freeciv-modpacks", env .. "freeciv-modpack", nil},
}
local toolsMenu = {
	{"&TES"  , toolsTesMenu  , nil},
	{"&FTL"  , toolsFtlMenu  , nil},
	{"&Other", toolsOtherMenu, nil},
}

--------------------------------------------------------------------------------
return {
	{"&Voxel"     , voxelMenu     , beautiful.icons .. "Categories/games.png"},
	{"&Strategy"  , strategyMenu  , beautiful.icons .. "Categories/games.png"},
	{"Stor&y"     , storyMenu     , beautiful.icons .. "Categories/games.png"},
	{"S&imulation", simulationMenu, beautiful.icons .. "Categories/games.png"},
	{"&RPG"       , rpgMenu       , beautiful.icons .. "Categories/games.png"},
	{"&Puzzle"    , puzzleMenu    , beautiful.icons .. "Categories/games.png"},
	{"&FPS"       , fpsMenu       , beautiful.icons .. "Categories/games.png"},
	{"&Arcade"    , arcadeMenu    , beautiful.icons .. "Categories/games.png"},
	{"&Other"     , otherMenu     , beautiful.icons .. "Categories/games.png"},
	{nil          , nil            , nil                                     },
	{"S&ervers"   , serversMenu   , nil                                      },
	{"&Tools"     , toolsMenu     , nil                                      },
	{"P&latforms" , platformsMenu , nil                                      },
}
